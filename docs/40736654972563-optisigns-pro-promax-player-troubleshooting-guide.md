...
article_hash: "c9fabdab459630f70f86a475ec8c7dfc6004296e60071f10cf52525ac5a1d9ff"
---
...
If you’ve got an OptiSigns Pro or ProMax Player and you’re having issues, you’ve come to the right place. For first time setup, see our [**Set Up the OptiSigns Pro Player**](/hc/en-us/articles/32272215514131-Optisigns-Pro-Digital-Signage-Player) or [**Set Up the OptiSigns ProMax Player**](/hc/en-us/articles/38680194603155-OptiSigns-ProMax-Player) articles. For more on the Pro or ProMax player features, see our [**Advanced Features**](/hc/en-us/articles/35577511423635-OptiSigns-Pro-Player-Advanced-Features) article.

---

## Best Practices

- Set up the [**Mobile Admin App**](/hc/en-us/articles/30003143806099-How-to-Use-the-OptiSigns-Mobile-Admin-App). This will allow you to use numerous features remotely, including the Remote Keyboard app and remote monitoring.
...
- If you have firewalls, make sure OptiSigns is whitelisted. Refer to our [**Whitelist Article**](/hc/en-us/articles/360047275934) for the required URLs and ports.
...
- If the device still cannot connect to any network, [**contact our support team**](/hc/en-us/articles/35626165056787-How-to-Contact-OptiSigns-Support). After a bit of troubleshooting, you may be asked to submit an [**RMA request**](#RMAProcess)**.**
...
See our [**Pro/Pro Max Player Advanced Features**](/hc/en-us/articles/35577511423635-OptiSigns-Pro-Player-Advanced-Features) article for information on setting these up.
...
2. By using the ***collectDeviceLog*** [**Remote Command**](/hc/en-us/articles/4408658251027-How-to-use-Remote-Command-Execution-Windows-Linux) from the OptiSigns portal. This will provide a download link that you can use to obtain the log:
...
See our [**Advanced Settings for the Pro/ProMax Player**](/hc/en-us/articles/35577511423635-OptiSigns-Pro-Player-Advanced-Features) article for more information.
...
See our article on [**how to install a root certificate and set up your internal website display**](/hc/en-us/articles/35184720136595-How-to-Install-a-Root-Certificate-and-Display-an-Internal-Website-on-Screens) for more information.
