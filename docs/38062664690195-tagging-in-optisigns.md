...
article_hash: "3be1d1fe723a381eaaa53f78bcb8dabf9414a5aedc9a0e486eea715ccd6440d2"
---
...
| --- |
| **NOTE** |
| Asset and screen tagging are distinct from [**content tags in playlists**](/hc/en-us/articles/20879903340947-How-to-Use-Content-Tags-in-The-Playlist). |
...
For more information on how to send Remote Commands via tag, see our article on [**Remote Command Execution**](/hc/en-us/articles/4408658251027-How-to-use-Remote-Command-Execution-Windows-Linux).
...
Tags may only be applied to existing assets in OptiSigns. To learn how to create an asset, see our article on [**How to Upload and Manage Files and Assets**](/hc/en-us/articles/360016247974-How-to-Upload-Manage-Your-Files-Assets)**.**
